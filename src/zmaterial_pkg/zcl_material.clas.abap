CLASS zcl_material DEFINITION
  ...
  PUBLIC SECTION.
    ...
    INTERFACES if_http_service_extension .
        DATA :tb_data       TYPE TABLE OF zmaterial_table,
          lt_json_table TYPE TABLE OF zmaterial_table,
          wa_data       TYPE zmaterial_table.
...
*        tb_data = lt_json_table.
          LOOP AT tb_data INTO DATA(ls_Material).
            MODIFY zmaterial_table FROM @ls_Material    .
*          count = count + 1.
          ENDLOOP.
