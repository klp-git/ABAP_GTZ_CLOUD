...
*    data(lv_page1) = 'ORIGINAL FOR RECIPIENT'
...
*    CONDENSE lv_formatted_time.
      ...
      lv_utc_time = wa_data-CreationTime.
...
*CONCATENATE wa_ship-StreetPrefixName1 wa_ship-StreetPrefixName2 wa_ship-cityname wa_ship-PostalCode wa_ship-DistrictName wa_ship-country   INTO wa_ship-StreetName SEPARATED BY SPACE.
      ...
      |<eway>{ wa_data-ewaybillno }</eway>| &&
      |<ewaydate>{ wa_data-ewaydate }</ewaydate>| &&
...
***************************************************************************************TRADENAME END
        LOOP AT lt_item2 INTO DATA(wa_item2) where BillingDocumentItem = wa_item-BillingDocumentItem.
...
*    CONCATENATE lv_header lv_item  INTO lv_header .
      ...
      wa_sold-StreetName = wa_sold-HouseNumber && ' ' && wa_sold-StreetName.
       ...
       data : lv_regionname type string.
       lv_regionname = wa_ship-RegionName.
       CONCATENATE lv_regionname ',' wa_ship-TaxNumber3+0(2) into lv_regionname.
      ...
      |<RegionName>{ lv_regionname }</RegionName>| &&
*      |<statecode>{ wa_ship-TaxNumber3+0(2) }<statecode>| &&
      |</ShipToParty>| &&
      |<SoldToParty>| &&
