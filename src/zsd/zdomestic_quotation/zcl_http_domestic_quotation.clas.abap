...
CLASS ZCL_HTTP_DOMESTIC_QUOTATION DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_HTTP_DOMESTIC_QUOTATION IMPLEMENTATION.
...
*     req_uri = request->get_request_uri( ).
    ...
    CASE request->get_method( ).
      ...
      WHEN CONV string( if_web_http_client=>post ).
        ...
        FIELDS Purchaserequisition WHERE Purchaserequisition = @lv_belnr "6000000002
        INTO @DATA(lv_belnr2).
