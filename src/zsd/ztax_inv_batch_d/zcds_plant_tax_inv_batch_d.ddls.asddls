...
define root view entity ZCDS_plant_TAX_INV_BATCH_D
  as select from zplant_table
{
...
//      
     ...
     typeofenterprise           as typeofenterprise,
      ...
      @UI.lineItem: [ { position: 210, label: 'Cost Center' } ]
      @UI.identification: [ { position: 210, label: 'Cost Center' } ]
      costcenter        as Costcenter,
      
      @EndUserText.label: 'Plant'
      @UI.lineItem: [ { position: 210, label: 'Plant' } ]
      @UI.identification: [ { position: 210, label: 'Plant' } ]
      plant        as Plant,
