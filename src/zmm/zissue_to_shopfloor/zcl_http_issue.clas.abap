CLASS ZCL_HTTP_ISSUE DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS ZCL_HTTP_ISSUE IMPLEMENTATION.
  ...
  |<form action="/sap/bc/http/sap/ZHTTP_ISSUE" method="POST">\n| &&
  |<H2>Issue To Shopkeeper</H2> \n| &&
  ...
  METHOD if_http_service_extension~handle_request.
    ...
    req_uri = '/sap/bc/http/sap/ZHTTP_ISSUE?sap-client=080'.
      ...
      WHEN CONV string( if_web_http_client=>post ).
       ...
       END OF ty_mat_process.
        ...
        IF wa_final IS NOT INITIAL.
          ...
          TRY.
              DATA(pdf) = zcl_driver_issue=>read_posts( process_no = lv_process1
                                                     mat_no = lv_mat1 ).
              IF  pdf = 'ERROR'.
...
*                             | </html>|.
  ...
  METHOD post_html.
   ...
   |<body> \n| &&
   |<title>Issue To Shopkeeper</title> \n| &&
   |<form action="/sap/bc/http/sap/ZHTTP_ISSUE" method="Get">\n| &&
