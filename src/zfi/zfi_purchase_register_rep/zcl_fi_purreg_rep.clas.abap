CLASS zcl_fi_purreg_rep DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_fi_purreg_rep IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    IF io_request->is_data_requested( ).
      ...
      DATA: lt_response    TYPE TABLE OF zpur_reg_ce,
      ...
      LOOP AT lt_filter_cond INTO DATA(ls_filter_cond).
        ...
        ELSEIF ls_filter_cond-name = 'IS_REVERSED'.
          DATA(lt_is_reversed) = ls_filter_cond-range[].
        ENDIF.
      ENDLOOP.
      ...
      a~AccountingDocumentType, a~PostingDate, a~CostElement, a~BusinessPlace, a~ProfitCenter, a~DocumentItemText,
      ...
      AND a~PurchasingDocument = '' AND a~CostElement <> '' AND a~TaxItemGroup <> '' AND a~TransactionTypeDetermination = '' AND
      ...
      AND a~AccountingDocumentType IN @lt_accountingdocumenttype AND b~IsReversed IN @lt_is_reversed
      """""""""""""""""""""""""""""""""""""""""""""""""""""""""""
*      AND a~AccountingDocument = '1900000019'
      INTO TABLE @DATA(it_bseg) PRIVILEGED ACCESS.

      SELECT FROM i_operationalacctgdoctaxitem
      FIELDS CompanyCode, FiscalYear, AccountingDocument, TaxCode
      WHERE TransactionTypeDetermination = 'NVV' AND TaxCode LIKE 'H%' AND CompanyCode IN @lt_bukrs
      AND AccountingDocument IN @lt_belnr AND FiscalYear IN @lt_gjahr
      INTO TABLE @DATA(it_taxitem) PRIVILEGED ACCESS.
      ...
      a~AmountInCompanyCodeCurrency, a~AccountingDocumentItemType, a~CostElement
      ...
      FIELDS CompanyCode, FiscalYear, AccountingDocument, AccountingDocumentTypeName
      WHERE AccountingDocument IN @lt_belnr AND CompanyCode IN @lt_bukrs AND FiscalYear IN @lt_gjahr
      AND Ledger = '0L'
      INTO TABLE @DATA(it_acctyname) PRIVILEGED ACCESS.
      ...
      LOOP AT it_bseg ASSIGNING FIELD-SYMBOL(<wa_bseg>).
        ...
        ls_response-item_text = <wa_bseg>-DocumentItemText.
        ls_response-gstinput_type = 'Eligible Credit'.
        ...
        IF <wa_bseg2> IS ASSIGNED.
          ...
          READ TABLE it_glaccount2 ASSIGNING FIELD-SYMBOL(<wa_glaccount2>) WITH KEY GLAccount = <wa_bseg>-CostElement.
        ...
        IF <wa_plant> IS ASSIGNED.
          ...
          UNASSIGN <wa_plant>.
        ELSE.
          READ TABLE it_plant ASSIGNING FIELD-SYMBOL(<wa_plant2>) WITH KEY PlantCode = <wa_bseg>-ProfitCenter+0(4).
          IF <wa_plant2> IS ASSIGNED.
            ls_response-plantname = <wa_plant2>-plantname.
            ls_response-plantgst  = <wa_plant2>-GstinNo.
            UNASSIGN <wa_plant2>.
          ENDIF.
        ENDIF.
        ...
        IF <wa_bseg3> IS ASSIGNED.
          ls_response-igst_receive = <wa_bseg3>-AmountInCompanyCodeCurrency.
          IF <wa_bseg>-AmountInCompanyCodeCurrency <> 0.
            ls_response-rate_igst = abs( ( <wa_bseg3>-AmountInCompanyCodeCurrency / <wa_bseg>-AmountInCompanyCodeCurrency ) * 100 ).
          ENDIF.
          UNASSIGN <wa_bseg3>.
        ENDIF.
        ...
        IF <wa_bseg4> IS ASSIGNED.
          ls_response-cgst_receive = <wa_bseg4>-AmountInCompanyCodeCurrency.
          ls_response-sgst_receive = <wa_bseg4>-AmountInCompanyCodeCurrency.
          IF <wa_bseg>-AmountInCompanyCodeCurrency <> 0.
            ls_response-rate_cgst = abs( ( <wa_bseg4>-AmountInCompanyCodeCurrency / <wa_bseg>-AmountInCompanyCodeCurrency ) * 100 ).
        ...
        IF <wa_bseg5> IS ASSIGNED.
          ls_response-ugst_receive = <wa_bseg5>-AmountInCompanyCodeCurrency.
          IF <wa_bseg>-AmountInCompanyCodeCurrency <> 0.
            ls_response-rate_ugst = abs( ( <wa_bseg5>-AmountInCompanyCodeCurrency / <wa_bseg>-AmountInCompanyCodeCurrency ) * 100 ).
          ENDIF.
          UNASSIGN <wa_bseg5>.
        ENDIF.
        ...
        IF <wa_bseg6> IS ASSIGNED.
          ls_response-rcm_cgst = <wa_bseg6>-AmountInCompanyCodeCurrency.
          ls_response-rcm_sgst = <wa_bseg6>-AmountInCompanyCodeCurrency.
          UNASSIGN <wa_bseg6>.
        ENDIF.
        ...
        IF <wa_bseg7> IS ASSIGNED.
          ls_response-rcm_igst = <wa_bseg7>-AmountInCompanyCodeCurrency.
          UNASSIGN <wa_bseg7>.
        ENDIF.
        ...
        IF <wa_bseg8> IS ASSIGNED.
          ls_response-rcm_ugst = <wa_bseg8>-AmountInCompanyCodeCurrency.
          UNASSIGN <wa_bseg8>.
        ENDIF.
        ...
        READ TABLE it_taxitem ASSIGNING FIELD-SYMBOL(<wa_taxitem>) WITH KEY AccountingDocument = <wa_bseg>-AccountingDocument
                                                                            CompanyCode        = <wa_bseg>-CompanyCode
                                                                            FiscalYear         = <wa_bseg>-FiscalYear.
        IF <wa_taxitem> IS ASSIGNED.
          ls_response-gstinput_type = 'Non-Eligible Credit'.
          UNASSIGN <wa_taxitem>.
        ENDIF.

        READ TABLE it_acctyname ASSIGNING FIELD-SYMBOL(<wa_actyname>) WITH KEY AccountingDocument = <wa_bseg>-AccountingDocument
                                                                               CompanyCode        = <wa_bseg>-CompanyCode
                                                                               FiscalYear         = <wa_bseg>-FiscalYear.
        IF <wa_actyname> IS ASSIGNED.
          ls_response-AccountingDocTypename = <wa_actyname>-AccountingDocumentTypeName.
          CLEAR <wa_actyname>.
        ENDIF.
      ...
      SORT lt_response BY bukrs gjahr belnr txgrp .
